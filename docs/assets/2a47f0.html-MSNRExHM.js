import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as s,c as a,e}from"./app-DLYfSG7h.js";const t={},l=e(`<h2 id="背景介绍" tabindex="-1"><a class="header-anchor" href="#背景介绍"><span>背景介绍</span></a></h2><blockquote><p>本故事发生在 2017年12月14号的笔记记录，系统环境大概是CentOS 7，但是系统是线上环境，没有互联网，安装软件繁琐。</p></blockquote><blockquote><p>当时需要用httpd2 来搭建一个简单的web服务器，但是系统没有安装httpd2，要求版本是 httpd2.4.29</p></blockquote><blockquote><p>当然现在通用的选择是 Nginx，所以本记录只对那些特殊情况下，特殊要求才适用。</p></blockquote><h2 id="操作记录" tabindex="-1"><a class="header-anchor" href="#操作记录"><span>操作记录</span></a></h2><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># 卸载系统原有的httpd</span>
